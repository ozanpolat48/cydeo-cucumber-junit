...
public class OrderStepDefinitions {
    ...
    public void userEntersQuantity(int quantity) {
        //accepting int argument and sending it using it using sendKeys() method  ///int argümanını kabul etmek ve onu sendKeys() yöntemini kullanarak göndermek// sendKeys() yöntemi yalnızca String'i kabul ettiğinden, ya "" ile eşleşmemiz gerekiyor veya String.valueOf(int) gönder;
       ...
       // orderPage.inputQuantity.clear();
        ...
        orderPage.inputQuantity.sendKeys(Keys.BACK_SPACE); // butonda bulunan var olanı siler
    ...
    public void user_selects_credit_card_type(String expectedCardType) {
        ...
        //This line will loop though the list and decide which radio button to click
