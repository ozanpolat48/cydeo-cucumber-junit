Feature: Web table user order feature
  ...
  Scenario Template: User should be able to place order and order seen in web table
    ...
    Examples: Famous female scientists
      ...
      | Screenable  | 4        | sscasdafwaew       | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | List Meitner       |
    ...
    Examples: Famous male scientists
      ...
      | Screenable  | 4        | CV Ramman             | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Cv Ramman             |
      ...
      | MoneyCog    | 7        | Arnold Schwarzenegger | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Arnold Schwarzenegger |
